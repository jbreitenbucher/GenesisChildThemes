...
function it_role_before_loop() {
	...
	if( !is_paged() && $term->slug == genesis_get_option('technology_staff_student_role', IT_SETTINGS_FIELD ) )
		{
			if (!genesis_get_option('technology_student_schedule', IT_SETTINGS_FIELD ) == '') {
			echo '<br />';
			echo '<iframe width="550" height="325" frameborder="0" src="https://docs.google.com/spreadsheet/pub?hl=en_US&hl=en_US&key='.  genesis_get_option('technology_student_schedule', IT_SETTINGS_FIELD ) . '&output=html&widget=true"></iframe>';
			}
		}
