...
/**
 * Create a custom Metabox for the itpeople post type
 *
 * @link http://www.billerickson.net/wordpress-metaboxes/
 *
 */
function itpeople_create_metaboxes( $meta_boxes ) {
...
add_filter( 'cmb_meta_boxes' , 'itpeople_create_metaboxes' );
 ...
 *
 */ 
function itpeople_initialize_cmb_meta_boxes() {
    if ( !class_exists( 'cmb_Meta_Box' ) ) {
        require_once( CHILD_DIR . '/lib/metabox/init.php' );
    }
}
add_action( 'init', 'itpeople_initialize_cmb_meta_boxes', 9999 );
