...
class Genesis_Custom_Featured_Post extends WP_Widget {
	...
	public function __construct() {
		...
		$widget_ops = array(
			...
			'description' => __( 'Custom Genesis featured posts with thumbnails', 'genesis' ),
		);
		...
		parent::__construct( 'custom-featured-post', __( 'Genesis - Custom Featured Posts', 'genesis' ), $widget_ops, $control_ops );
