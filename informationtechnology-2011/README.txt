<strong>INFORMATION TECHNOLOGY THEME</strong>
<a href="http://instructionaltechnology.wooster.edu/themes/informationtechnology</a>

<strong>INSTALL</strong>
1. Upload the Information Technology child theme folder via FTP to your wp-content/themes/ directory. (The Genesis parent theme needs to be in the wp-content/themes/ directory as well.)
2. Go to your WordPress dashboard and select Appearance.
3. Activate the Information Technology theme.
...
By default WordPress will create a default thumbnail image for each image you upload and the size can be specified in your dashboard under Settings > Media. In addition, the Information Technology child theme creates the following thumbnail images you'll see below. These are the recommended thumbnail sizes that are used on the Information Technology child theme demo site.
