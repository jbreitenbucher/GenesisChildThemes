...
add_action('genesis_before','mcedc_committee_loop_setup');
function mcedc_committee_loop_setup() {
    ...
    add_action('genesis_loop', 'mcedc_committee_page_loop');
...
function mcedc_committee_page_loop() {
    $mcedc_committee_args = array(
        'post_type' => 'staff',
    ...
    query_posts( $mcedc_committee_args );
    echo '<h1 class="role-executive-committee">Executive Committee</h1>';
    while (have_posts()) : the_post();
        mcedc_committee_page_loop_content();
    endwhile;
}
...
function mcedc_committee_page_loop_content() {
    global $post;
