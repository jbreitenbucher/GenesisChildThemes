...
add_action('genesis_before','mcedc_archive_loop_setup');
function mcedc_archive_loop_setup() {
    ...
    add_action('genesis_loop', 'mcedc_archive_loop');
    ...
    add_action('genesis_post_content','mcedc_archive_post_content');
    ...
    add_action('genesis_after_endwhile', 'mcedc_archive_after_endwhile');
}
...
function mcedc_archive_post_content () {
    global $post;
...
function mcedc_archive_after_endwhile() {
