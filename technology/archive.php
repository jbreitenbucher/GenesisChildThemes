...
add_action('genesis_before','tech_all_archive_loop_setup');
function tech_all_archive_loop_setup() {
    ...
    add_action('genesis_entry_content','tech_all_archive_entry_content');
...
function tech_all_archive_entry_content () {
