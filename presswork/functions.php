	...
	if($name=="header_logo") {
		$handle = pw_handles('Header Logo', 'header_logo', true, 'header'); 
	   	...
	   	<li id="header_logo" class="mainl">
            <?php echo $handle; ?>
            <div id="site-logo" class="siteheader"><h1><?php bloginfo('name'); ?></h1><a href="<?php echo home_url(); ?>/"><img src="<?php echo pw_theme_option("header_logo"); ?>" alt="<?php bloginfo("name"); ?>" title="<?php bloginfo("name"); ?>" /></a></div>
        </li>
		<?php
	}	
	if($name=="description") {
