...
add_action('genesis_before','tpg_page_loop_setup');
function tpg_page_loop_setup() {
	...
	add_action('genesis_post_content','tpg_page_content');
	...
	add_action('genesis_after_endwhile', 'tpg_page_after_endwhile');
}
...
function tpg_page_after_endwhile() {
